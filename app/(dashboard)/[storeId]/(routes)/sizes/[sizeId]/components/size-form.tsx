...
export const SizeForm: React.FC<SizeFormProps> = ({
  ...
  const description = initialData ? 'Editar un Tamaño.' : 'Agregar un Nuevo Tamaño';
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error('Asegurate de haber eliminado todos los productos que esten usando el Tamaño primero.');
    } finally {
      setLoading(false);
      setOpen(false);
    }
